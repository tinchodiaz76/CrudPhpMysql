...
05/10/2021*/									
		...
		<script type="text/javascript">
			...
			function abm2(rowId, action){	
				switch (action) {
					case 'delete':
						var q_desc = 'Esta seguro que quiere borrar la pregunta frecuente '+rowId+' ?';
						break;					
					case 'activar':
						var q_desc = 'Esta seguro que quiere activar la pregunta frecuente '+rowId+' ?';
						break;
				}	
				//change input hiddens values:                
				document.getElementById("id_hidden").value = rowId;
				...
				$("#modalTitle2").html('UNAJ | Preguntas Frecuentes');               	
			...
			function ResultsToTable2(){            
				$("#table-1").tableExport({
					...
					fileName: "PreguntasFrecuentes",    //Nombre del archivo 
				});
			}
		</script>
