						...
						<?php
							...
							// if (mysqli_affected_rows($con) != 0) {
							    while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
									...
									echo"	</a>";
									if ($row['activo'] == 1){											
                                        echo"	<a onclick=\"abm(" . $msgid . ",'delete');\" class='btn btn-primary btn-red a-btn-slide-text'>";
                                        echo"		<span class='glyphicon glyphicon-remove' aria-hidden='true'></span>";
                                        echo"		<span><strong>Delete</strong></span>";            
                                        echo"	</a>";	
                                    } else {
                                        echo"	<a onclick=\"abm(" . $msgid . ",'activar');\" class='btn btn-primary btn-green a-btn-slide-text'>";
                                        echo"		<span class='glyphicon glyphicon-remove' aria-hidden='true'></span>";
